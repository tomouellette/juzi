...
def similarity(
    ...
    at each threshold — look for an elbow or plateau where the number
    of retained factors stabilises.
    ...
    # Factors not in sim_idx are always False (excluded by pruning)
